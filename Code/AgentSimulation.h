...
static const double mi = 2;  //The internal average infection rate
static const double ph = 0.3; //The fraction of high contact individuals
static const double ml = 1; //The contact rate of low risk group
static const double mh = ((mi - ml * (1 - ph)) / (ph)); //The contact rate of high risk group
static const double ms = 1; //The dispersion of contact rate
static const double T = 1500; //The total testing capacity
static const double f = 0.5; // the deflation factor for frequency of testing for high risk group
...
static const double b0 = 0.01; //The base level infectivity
static const double me = 1; //External contact rate
static const double rho = 0.0037; //External positivity of the environment
...
static const int U0 = 2; //Initial infection load

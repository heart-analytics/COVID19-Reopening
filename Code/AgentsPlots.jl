...
PlotFiles = ["ARGONNE_0", "ARGONNE_50", "ARGONNE_100",
                "ARGONNE_200", "ARGONNE_300", "ARGONNE_500",
                "ARGONNE_50_H", "ARGONNE_50_H_1", "ARGONNE_50_H_4",
                "ARGONNE_50_H_8"]
...
for file in PlotFiles
    # load S and U
    for i in 1:N
        df = DataFrame(CSV.File(joinpath(dataDir, string("$(i)_OUTPUT_$(file)"))));
        for t in 1:T
